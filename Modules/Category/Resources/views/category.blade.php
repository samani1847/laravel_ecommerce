...
@section('scriptfile')
    ...
    <script>
        ...
        function edit(id, idModal='#categoryModal'){
            ...
            form[0].reset();
            axios.get("{{ url('/category/get') }}"+'/'+id).then(function (response){
            ...
            form.submit(function(e){
                e.preventDefault();
                axios.put("{{ url('/category/update')}}"+'/'+id, form.serialize())
        ...
        function addCategory(){
            ...
            form.submit(function(e) {
                e.preventDefault();
                axios.post("{{ url('/category/store') }}", form.serialize()).then(function (response){
                    toastr.clear();
        ...
        function deleteCategory(){
            ...
            form.submit(function(e) {
                e.preventDefault();
                axios.delete("{{ url('/category/delete') }}"+'/'+id).then(function (response){
                    toastr.clear();
                    toastr.success('Category deleted successfully', 'Success');
                    table.ajax.reload();
                })
